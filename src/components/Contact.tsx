      ...
      <div className='container'>
        ...
        <form action="" className=' w-1/2 m-auto'>
          <div className='flex flex-col my-7'>
            ...
            <input type="text" placeholder='First Name' className='appearance-none bg-transparent border mt-2  rounded-xl w-full p-5 text-gray-700 leading-tight focus:outline-none focus:shadow-outline block' />
          </div>
          <div className='flex flex-col my-7'>
            <label className='font-semibold text-sm text-black text-opacity-70' htmlFor="">Last name</label>
            <input type="text" placeholder='Last Name' className='appearance-none bg-transparent border mt-2  rounded-xl w-full p-5 text-gray-700 leading-tight focus:outline-none focus:shadow-outline block' />
          </div>
          <div className='flex flex-col my-7'>
            <label className='font-semibold text-sm text-black text-opacity-70' htmlFor="">Location</label>
           
            <select name="" id="" className='appearance-none bg-transparent border mt-2  rounded-xl w-full p-5 text-gray-700 leading-tight focus:outline-none focus:shadow-outline block'>
